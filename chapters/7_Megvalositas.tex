...
\begin{itemize}
    ...
    \item értékadáshoz esetén eltároljuk a változót és annak típusát a jelenlegi típus-szótárba, megbizonyosdva afelől, hogy a változóhoz rendelt érték típusa nem üres-típus,
...
Egy kód által csak indirekt módon változtatható regiszter, mellyel számontartjuk a jelenleg végrehajtott utasítás indexét. Értéke 1-el nő minden végrehajtási lépés után, beleértve az ugrásokat is, hisz a \texttt{LABEL} utasítás amit így átugrunk amúgy se végez egyéb feladatot.
...
A program memóriáját egy dinamikusan növekvő tömbbel szimuláljuk, mely feladata atomi értékek és ezekből felépülő tömbök eltárolása. Az egyes memóriacellákat azok sorszáma alapján azonosítjuk.

A futtatási környezet számontartja mely cellák címei vannak változóhoz kötve vagy vannak elhelyezve a vermen. Ezeken végigiterálva meg tudjuk vizsgálni mely memóriacellák tartalmaznak még használt adatokat és melyeket szabadíthatjuk fel új értékek számára.
...
\codetable{Ugrásokra vonatkozó utasítások}{code_jump}{
    LABEL & név & Létrehoz egy \textit{név} nevű cimkét, melyre az ugrások hivatkozhatnak. Egyéb műveletet nem végez. \\
...
\codetable{Függvényhívás és visszatérési utasítások}{code_func}{
    ...
    RETCMP & hossz & \textit{hossz} hosszúságú tömböt készít a veremben lévő elemekből, majd egy erre mutató címet helyez el a tömbön. Ezután a fentebb tárgyalt módon visszatér. \\
}
