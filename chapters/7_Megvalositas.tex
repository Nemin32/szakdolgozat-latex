...
Ezt elkerülvén a parserek mellé még egy osztályt implementáltam, mely a Haskell nyelv úgynevezett \textit{"do"} ("csináld") szintaxisát imitálja. Ennek lényege, hogy a monadikus függvények egymáson való beágyazott meghívását lineáris kóddá tudjuk alakítani úgy, hogy ugyanazt a végeredményt produkálja.
...
\begin{itemize}
        ...
        \item \textbf{Változók} (variables) - Egy változótartományokra (ezek működését részletesebben a \ref{code_scope} fejezetben tárgyalom) bontott asszociatív tömb. Elemei szöveges neveket párosítanak mutatókkal (melyek a változóhoz tartozó memóriacella címének számszerű értéke).
...
\addimage{screenshot_edited.png}{Egy a felhasználói felületről készült képernyőkép.}{screenshot}
