A tervezett értelmezőnek képesnek kell lennie a felhasználó által szolgáltatott nyers szövegen olyan átalakításokat végeznie, melynek végeredménye egy megállítható és léptethető programkód. A következő fejezetekben ezen átalakításokat veszem sorra:
...
\say{\textit{A kapcsos-zárójelek elhelyezése kevésbé fontos, ám az embereknek szenvedélyes meggyőződéseik vannak velük kapcsolatban. Mi az egyik közkedvelt stílust választottuk. Válassz egy olyat, ami számodra megfelelő, aztán tartsd hozzá magad.}}\cite{kr}
...
\say{\textit{Az első lépés bármely értelmező vagy fordító létrehozásában a szkennelés. A szkenner a nyers bemeneti forráskódot karakterek sorozataként fogadja, majd ezeket tokeneknek nevezett csoportokba gyűjti. Ezek a nyelv értelmes \say{szavai}} és \say{\textit{írásjelei}} melyek kialakítják annak nyelvtanát.}
